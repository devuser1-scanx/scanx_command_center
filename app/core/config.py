...
class Settings(BaseSettings):
    ...
    # Report download links texted to patients are generated by the
    # already-deployed scanx-pdf-proxy service, not by Command Center - it
    # owns its own link storage, 7-day expiry, and patient-facing
    # "request a new link" self-service page.
